...
const VideoItem = ({ mix, onClick }: { mix: any; onClick: () => void }) => {
    ...
    return (
        <div onClick={onClick} className="cursor-pointer md:w-52 w-40 my-1 hover:bg-gray-100 border-gray-320 md:m-2 min-h-[100px] min-w-[90px] xl:min-w-[320px] md:min-w-[190px]  rounded-2xl">
            <div className="w-full h-32 relative flex items-center justify-center">
                ...
                <img src={mix && mix.video_thumbnail ? mix.video_thumbnail :
                    'https://png.pngtree.com/png-vector/20190605/ourmid/pngtree-headphones-icon-png-image_1477434.jpg'} alt="" className="w-full h-full object-cover rounded-2xl" />
            </div>
            <div className="my-2">
...
function TrendingPage() {
    ...
    return (
        <div className='w-full mt-4 h-full'>
            <header className="w-full mt-3 flex items-right justify-end">
                <div className="hidden md:flex md:flex-row flex-col items-right">

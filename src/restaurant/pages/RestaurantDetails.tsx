...
const RestaurantDetails = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                const responseRoute = await axios.get(`https://warm-journey-18609535df73.herokuapp.com/api/v1/restaurant/update_restaurant/${id}/`, {
                    headers: {
                ...
                const responseController = await axios.get(`https://warm-journey-18609535df73.herokuapp.com/api/v1/restaurant/controller/${id}/`, {
                    headers: {
                        Authorization: `Bearer ${userToken}`,
                    },
                });
                ...
                const responsePlayer = await axios.get(`https://warm-journey-18609535df73.herokuapp.com/api/v1/restaurant/player/${id}/`, {
                    headers: {
                        Authorization: `Bearer ${userToken}`,
                    },
                });
    ...
    const handleControllerModalSubmit = async (event: FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            const controllerCreation = await axios.post(`https://warm-journey-18609535df73.herokuapp.com/api/v1/restaurant/create_controller/${id}/`, controllerDetails, {
                headers: {
                    Authorization: `Bearer ${userToken}`,
                },
            });
    ...
    const handlePlayerModalSubmit = async (event: FormEvent<HTMLFormElement>) => {
        event.preventDefault();
        const playerPassword = (document.getElementById('player_password') as HTMLInputElement).value;

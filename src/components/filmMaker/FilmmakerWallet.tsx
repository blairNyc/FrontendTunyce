        ...
        <div className="mt-8 h-full">
            ...
            <div className='bg-white w-full rounded-xl h-full mx-2 px-2'>
                <div className='my-2'>
                    ...
                    <div className='flex items-center'>
                        <StatItem text='Total Balance' currentPrice={250000} lastPrice={240000}>
                            {/* ... */}
                        </StatItem>
                        <StatItem text='Total Earned' currentPrice={19000} lastPrice={220000}>
                            {/* ... */}
                        </StatItem>
                        <StatItem text='Total Withdrawn' currentPrice={16000} lastPrice={15000}>
                            {/* ... */}
                        </StatItem>
                    </div>
                </div>
...
export default FilmmakerWalletPage;